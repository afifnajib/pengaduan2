    ...
    <div class="page">
          ...
          <nav class="rd-navbar rd-navbar-transparent" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-xl-layout="rd-navbar-static" data-xl-device-layout="rd-navbar-static" data-lg-stick-up-offset="20px" data-xl-stick-up-offset="20px" data-xxl-stick-up-offset="20px" data-lg-stick-up="true" data-xl-stick-up="true" data-xxl-stick-up="true">
            ...
            <div class="rd-navbar-aside-outer rd-navbar-collapse">
              <div class="rd-navbar-aside">
                ...
                <ul class="list-lined">
                  <li><a href="#" class="icon fa fa-instagram fa-2x"></a></li>
                  <li><a href="#" class="icon fa fa-facebook fa-2x"></a></li>
                  <li><a href="#" class="icon fa fa-twitter fa-2x"></a></li>
                </ul>
              </div>
            </div>
      ...
      <section class="section swiper-container swiper-slider swiper-slider-1 context-dark" data-loop="true" data-autoplay="5000" data-simulate-touch="false">
        <div class="swiper-wrapper">
          <div class="swiper-slide" data-slide-bg="assets/images/index-1-slider-1-1920x768.jpg">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">
                    ...
                    <div class="button-wrap-default" data-caption-animate="fadeInUp" data-caption-delay="450"><a class="button button-secondary-text" href="register.php">Register Now</a></div>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="assets/images/index-1-slider-2-1920x768.jpg">
            <div class="swiper-slide-caption section-lg">
              <div class="container">
                <div class="row">
                  <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">
                    ...
                    <div class="button-wrap-default" data-caption-animate="fadeInUp" data-caption-delay="450"><a class="button button-secondary-text" href="login.php">Login</a></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!--Icon List 2-->
      <section id="getstarted" class="section section-sm section-sm-bottom-100 bg-primary">
        <div class="container">
      ...
      <section class="section bg-gray-100 box-image-left">
        ...
        <div class="box-image-item box-image-video novi-background bg-image" style="background-image: url(assets/images/index-874x534.jpg)"><a class="icon novi-icon fa fa-caret-right" href="//www.youtube.com/embed/KFVUxSynSXc" data-lightgallery="item"></a></div>
      </section>
      <!-- Our Mission-->
      ...
      <section class="parallax-container" data-parallax-img="assets/images/parallax-1-1920x1026.jpg">
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-10 col-xl-9">
                ...
                <!--TimeCircles-->
                      <div class="countdown" data-countdown data-to="2020-12-3">
      ...
      <section class="section bg-default section-md">
        <div class="container">
          ...
          <div class="box-image-small box-image-small-left">
            <div class="item-image bg-image novi-nackground" style="background-image: url(assets/images/index-1-2-586x334.jpg)"></div>
          ...
          <div class="box-image-small box-image-small-right">
            <div class="item-image bg-image novi-nackground" style="background-image: url(assets/images/index-1-3-580x334.jpg)"></div>
