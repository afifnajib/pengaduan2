                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <button class="btn btn-primary mt-3" data-toggle="modal" title="Detail" data-target="#myMtp"><i class="fa fa-user-plus"> Tambah Petugas</i></button>
                            <div class="table-responsive mt-3">
                                <table id="table-masyarakat" class="display table">
                                    ...
                                    <tbody>  
                                    <?php
                                    $dmq = mysqli_query($config,"SELECT * FROM petugas WHERE level='petugas'");
                                    $no = 1;
                                    while($ddata = mysqli_fetch_array($dmq)){
                                        ...
                                        <tr class="text-center">
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $ddata['nama_petugas']; ?></td>
                                            ...
                                            <?php 
                                             ...
                                             ?>
                                             <td>
                                                <button class="btn btn-info" data-toggle="modal" title="Detail" data-target="#myMdm<?php echo $ddata['id_petugas']; ?>"><i class="fas fa-info"></i></button>
                                                <?php include 'p_dp.php'; ?>
                                                <button class="btn btn-warning" data-toggle="modal" title="Edit" data-target="#myMdm2<?php echo $ddata['id_petugas']; ?>"><i class="fas fa-edit"></i></button>
                                                   ...
                                                   Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                      Swal.fire(
                                                        ...
                                                        'success',
                                                        window.location.href="hapus_masyarakat.php?nik=<?php echo $ddata['id_petugas']; ?>",
                                                        )
                                                  }
                                              })
                                            };
