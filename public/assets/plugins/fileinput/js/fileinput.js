...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-kv btn-default',
            fullscreen: 'btn btn-sm btn-kv btn-default',
            borderless: 'btn btn-sm btn-kv btn-default',
            close: 'btn btn-sm btn-kv btn-default'
        },
        previewTemplates: {},
        previewContentTemplates: {},
        ...
        browseClass: 'btn btn-primary btn-outline-secondary br2',
        removeIcon: '<i class="fas fa-trash"></i>',
        removeClass: 'btn btn-default btn-secondary br1 br2',
        cancelIcon: '<i class="fas fa-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        pauseIcon: '<i class="fas fa-pause"></i>',
        pauseClass: 'btn btn-default btn-secondary',
        uploadIcon: '<i class="fas fa-upload"></i>',
        uploadClass: 'btn btn-default btn-secondary br1 br2',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
